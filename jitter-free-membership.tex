...
of the membership state machines could entirely proscribe such changes to
reduce the risk of operator error, or could at least require a \textit{safety
catch} to be explicitly disabled before performing unsafe membership changes.
