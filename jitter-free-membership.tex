...
failure throughout. It also has no node with a casting voite in era $e+1$. On the
other hand the following sequence requires only three separate sets of infrastructure:
\[\begin{array}{rcccc}
%
\textrm{node}&a_{\textrm{old}}&a_{\textrm{new}}&a_1&a_2 \\
%
