...
even under the weaker assumption that $Q^\textrm{I}(p_1) \ne
Q^\textrm{II}(p_2)$ as long as $Q^\textrm{I}(p_1) \smile Q^\textrm{II}(p_2)$
for all proposals $p_1 \succ p_2$ having $\prop{}{p_1}$ and $\chosen{}{p_2}$.
