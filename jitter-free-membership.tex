...
Cheap Paxos algorithm effectively implements $v$ as an optimised version of an
insert-only set \cite{crdts} of pairs ${\{ \langle p, v(p) \rangle \mid
\prop{}{p} \}}$ which is replicated across the $f+1$ primary processors, with
the $f$ auxiliary processors storing just the hashes of values to ensure
integrity.
