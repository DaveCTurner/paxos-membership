...
respond in a timely fashion. More precisely, it was required that for each
ballot $b$ and each node $a$ there was a ballot $b' \succ b$ having $\owner{b'}
= a$. It was clear that there was no upper bound on suitable values for $b$.
