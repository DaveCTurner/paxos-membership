...
\QII{e}$ for all $e$. The integer $e$ is known as the \textit{era} of a
configuration. Most Paxos instances will use $\QI{e}$ and $\QII{e}$ for their
phase-I and phase-II quorums respectively, but instances may also use
$\QI{e-1}$ and $\QII{e}$ by the observation of \ref{per-phase-quorums} above.
