...
$Q^\textrm{I}_{e-1}$ and $Q^\textrm{II}_e$ can be used for the phase-I and
...
number $e(b)$ to each ballot $b$. A node may emit $\prop{i}{b}$ only if $e(b)
\le e(i)$ and it has received promises for ballot $b$ in instance $i$ from a
quorum in $Q^\textrm{I}_{e(b)}$. A node may decide $\chosen{i}{b}$ only if
${e(i) \le e(b)+1}$ and it has received $\acc{i}{a}{b}$ from a quorum in
...
+ 1$ and therefore that the epochs used in the two phases are close enough to
ensure consistency.
