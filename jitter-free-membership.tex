...
\frown Q^\textrm{II}(p_2)$ only when $\chosen{}{p_2}$ and $p_1 \succ p_2$.
...
zones\footnote{For instance, at time of writing, only one Amazon Web Services
  ...
  have three: \texttt{ap-southeast-2}, \texttt{eu-west-1}, \texttt{sa-east-1}
  and \texttt{us-west-2}. Similarly, only one Google Cloud Platform region
