...
Membership changes are handled by defining a sequence of memberships $Q_1, Q_2,
\ldots$ that is itself chosen by Paxos.  More precisely, there is a state
machine whose state is a finite sequence of memberships $Q_1, Q_2, \ldots, Q_m$
