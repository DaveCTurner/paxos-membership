...
$e(\cdot)$, which respectively assign an epoch number $e(i) > 0$ to each
instance $i$, and an epoch number $e(b)$ to each ballot $b$. A node may emit
...
II configurations) and the epoch numbers of instances are tracked by a state
...
configuration-sequence state machine. Epoch numbers $e(b)$ for ballots $b$ are
