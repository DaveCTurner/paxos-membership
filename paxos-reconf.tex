...
terminology is not used here to avoid confusion with the epochs (views, terms,
\ldots) of the leader-election protocol which track the current leader rather
