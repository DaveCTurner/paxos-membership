...
\item \label{synod-prop} If $\prop{}{b}$ then there is a quorum $q^\textrm{I}
  ...
  if also ${P = \{ b' \mid \exists a \in q^\textrm{I}.  \bprom{}{a}{b}{b'} \}
  \ne \varnothing}$ then $v(b) = v\bigl(\mathrm{max}(P)\bigr)$.
...
Furthermore if $P = \{ b' \mid \exists a \in q. \bprom{i}{a}{b}{b'} \} \ne
\varnothing$ then $v_i(b) = v_i\bigl(\mathrm{max}(P)\bigr)$.
