...
Birman, Malkhi and van Renesse \cite{virt-synch} noted that many real-world
implementations of Paxos either do not support reconfiguration or set $\alpha =
1$, effectively disabling pipelining.
