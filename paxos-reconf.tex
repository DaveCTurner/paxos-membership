...
in theorem \ref{synod-safety-theorem}. The extra flexibility in quorums, and
the removal of values from messages, are the two main differences between this
theorem and the corresponding ones in earlier work.
