...
one starts. Stoppable Paxos improves on Dynamic Paxos by removing the need for
a pipeline limit when the configuration is static and only imposes a limit when
