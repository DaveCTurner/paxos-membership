...
locale topologyL
  = q: fixedSeqL quorums_seq "(%(q1,_) (_,q2). (ALL S1 S2. q1 S1 \<longrightarrow> q2 S2 \<longrightarrow> S1 \<inter> S2 \<noteq> {}))"
                                                  all_values quorums_to quorum valid_quorum
  + e: fixedSeqL epochs_seq  "(%e1 e2. e1 \<le> e2)"  all_values epochs_to  epoch  valid_epoch
